...
| 回退到 D0 | 07-06 | 返回 D0 版本（五层架构，2284 行 23 文件）| 用户感觉功能一下子加太多，无从下手；将所有深化内容保存为补丁 D:\mini_code_d3_d11.patch (113KB)，恢复说明 evaluation/rollback_summary.txt | 按补丁文件逐步恢复，按 CL 历史逐个 cherry-pick |
